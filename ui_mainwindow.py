...
################################################################################
## Form generated from reading UI file 'ui_mainwindowdLtRtY.ui'
##
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        MainWindow.resize(1395, 679)
        MainWindow.setMinimumSize(QSize(1200, 600))
        MainWindow.setSizeIncrement(QSize(0, 0))
        MainWindow.setStyleSheet(u"border-image: url(:/prefijoNuevo/MillSection_2.png);")
        ...
        self.gridLayout.setContentsMargins(200, 50, 300, 250)
